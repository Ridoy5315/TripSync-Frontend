...
export default function Footer() {
  return (
    <>
            ...
            <div className="flex-1 lg:space-y-16 space-y-10">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-4 grid-cols-3 justify-center md:gap-0 gap-8">
                ...
                <ul className="flex lg:justify-end md:justify-end lg:gap-6 gap-3 ">
                  ...
                  <li>
                    <a
                      href="https://github.com/Ridoy5315"
                      rel="noopener noreferrer"
                      target="_blank"
                      className="text-muted-foreground transition hover:opacity-75"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.facebook.com/ridoy5287"
                      rel="noopener noreferrer"
                      target="_blank"
                      className="text-muted-foreground transition hover:opacity-75"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/ridoy.st99"
                      rel="noopener noreferrer"
                      target="_blank"
                      className="text-muted-foreground transition hover:opacity-75"
                    >
                  ...
                  <li>
                    <a
                      href="https://x.com/mahbubul_ridoy"
                      rel="noopener noreferrer"
                      target="_blank"
                      className="text-muted-foreground transition hover:opacity-75"
                    >
      ...
      {/* <footer className="bg-sidebar-accent pt-20">
